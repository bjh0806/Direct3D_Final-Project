...
class CTreeObject : public CHellicopterObject
{
public:
	CTreeObject();
	virtual ~CTreeObject();
...
class CCarObject : public CHellicopterObject
{
public:
	CCarObject();
	virtual ~CCarObject();
...
class CLineObject : public CHellicopterObject
{
public:
	CLineObject();
	virtual ~CLineObject();
...
class CSideObject : public CHellicopterObject
{
public:
	CSideObject();
	virtual ~CSideObject();
...
class CSideLineObject : public CHellicopterObject
{
public:
	CSideLineObject();
	virtual ~CSideLineObject();
};

class CRockObject : public CHellicopterObject
{
public:
	CRockObject();
	virtual ~CRockObject();
