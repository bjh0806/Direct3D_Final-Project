	...
	case WM_KEYUP:
		...
		case 'R':
			if (m_pScene->SceneNum == 1) {
				m_pScene->Low++;
				if (m_pScene->Low % 2 == 0) {
					m_pPlayer->SetPosition(XMFLOAT3(0.0f, 700.0f, -1300.0f));
				}
				else {
...
void CGameFramework::FrameAdvance()
{
	...
	if (m_pScene->Light % 2 == 1) {
		pfClearColor[0] = 0.35f;
		pfClearColor[1] = 0.35f;
		pfClearColor[2] = 0.85f;
		pfClearColor[3] = 1.0f;
	}
	else {
		pfClearColor[0] = 0.15f;
		pfClearColor[1] = 0.15f;
		pfClearColor[2] = 0.15f;
		pfClearColor[3] = 1.0f;
	}
