...
void CObjectsShader::Render(ID3D12GraphicsCommandList *pd3dCommandList, CCamera *pCamera)
{
	...
	for (int j = 0; j < m_nObjects; j++)
	{
		m_pObjects[j]->m_xmBoundingBox = BoundingBox(XMFLOAT3(m_ppObjects[j]->GetPosition()), m_ppObjects[j]->m_pObjectSize);
		m_pObjects[j]->m_pObjectCollided = NULL;
